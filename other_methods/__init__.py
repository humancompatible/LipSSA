...
from .stochastic_approximation_EqDiv import StochasticApproximationEqDiv
from .stochastic_approximation_ucb_dynamic import StochasticApproximationUCBDynamic

OTHER_METHODS = [CLEVER, FastLip, FastLip2, LipLP, NaiveUB, RandomLB, SeqLip, ZLip, StochasticApproximation,
                 StochasticApproximationEqDiv, StochasticApproximationUCBDynamic, LipSDP]
